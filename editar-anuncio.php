...
if(isset($_POST['titulo']) && !empty($_POST['titulo'])) {
    ...
    $a->editAnuncio($_GET['id'], $titulo, $categoria, $valor, $descricao, $estado, $fotos);
        ...
        <div class="form-group">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php foreach($info['fotos'] as $f): ?>
                        <div class="foto_item">
                            <img src="assets/images/anuncios/<?php echo $f['url']; ?>" class="img-thumbnail" border="0" />
                            <a href="excluir-foto.php?id=<?php echo $f['id']; ?>" class="btn btn-default">Excluir Imagem</a>
                        </div>
                    <?php endforeach; ?>
                </div>
            </div>
